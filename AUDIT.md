...
## Deprecated casks — resolved

`alacritty`, `qbittorrent` and `stolendata-mpv` all failed the macOS Gatekeeper
check and were due to be **disabled on 2026-09-01**. All three removed:
